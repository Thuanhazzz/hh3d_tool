...
function initializeUI() {
  ...
  try {
    toggleBtn.innerHTML = `
      <div class="toggle-btn-inner" style="position: relative; width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 50%;">
        <img class="loading-gif" src="https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExcmozbThleGQ5ZmY1bWV3eDlubGJxcGcxaWh3bnZhNDhhc2FpdDRyaCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/l41lZMazzdfs4sGtO/giphy.gif" style="display: none; position: absolute; width: 70px; height: 70px; pointer-events: none; border-radius: 50%; object-fit: cover; clip-path: circle(50%);" alt="Loading">
  ...
  panel.innerHTML = `
    ...
    <div id="hh3d-tasks-container" style="flex: 1; overflow-y: auto; padding: 15px; max-height: 94vh;"></div>
  `;
